    ...
    <section className="featured-blush section-pad" aria-labelledby="featured-blush-title">
      <div className="section-shell featured-blush__grid">
        <Reveal className="featured-blush__image">
          <Image src="/images/makeup-liquid-blush.png" alt="Liquid Blush Nº02 ROSÉ em vidro rosado com aplicador" fill sizes="(max-width: 767px) 92vw, 48vw" />
        </Reveal>
        <Reveal className="featured-blush__copy" delay={80}>
          <p className="eyebrow">Produto em destaque</p>
          <h2 id="featured-blush-title">LIQUID BLUSH<br /><em>Nº02</em></h2>
          <p className="featured-blush__statement">Cor intensa.<br />Textura leve.<br />Acabamento natural.</p>
